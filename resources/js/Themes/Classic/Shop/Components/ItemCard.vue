...
<template>
    <div class="bg-white rounded-lg shadow-md">
        ...
        <div class="text-[10px] py-3 px-2.5 border-t border-dashed flex items-center justify-between">
            ...
            <div>
                <button :disabled="$page.props.maintenance" @click="addToCart" type="button" class="rounded bg-blue-600 px-2 py-1 text-xs font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600" :class="$page.props.maintenance ? 'bg-gray-400 hover:bg-gray-300 cursor-not-allowed' : ''">
                    Add to Cart
                </button>
            </div>
        </div>
