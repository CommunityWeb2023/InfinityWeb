...
<template>
    <Dashboard :full-page="true">
        <div class="my-10 border-b border-t border-dashed py-5 bg-gray-100 ">
            <SwitchGroup as="div" class="flex items-center justify-between px-4 sm:px-6 lg:px-8">
                <span class="flex flex-grow flex-col">
                    <SwitchLabel as="span" class="text-sm font-medium leading-6 text-gray-900" passive>
                        Maintenance Mode
                    </SwitchLabel>
                    <SwitchDescription as="span" class="text-sm text-gray-500">
                        Enable maintenance mode. Only administrators can access the website. Disable all functions on the website.
                    </SwitchDescription>
                </span>
                <Switch v-model="settings.maintenance"
                    :class="[settings.maintenance ? 'bg-red-500' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2']">
                    <span aria-hidden="true"
                        :class="[settings.maintenance ? 'translate-x-5' : 'translate-x-0', 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out']" />
                </Switch>
            </SwitchGroup>
        </div>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="my-10 ">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="number" min="0" v-model="settings.drop_rate" name="drop_rate" id="drop_rate"
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="number" min="0" v-model="settings.penya_rate" name="penya_rate" id="penya_rate"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    ...
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="number" min="0" v-model="settings.exp_rate" name="exp_rate" id="exp_rate"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            ...
            <div class="my-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="mt-2">
                            <input type="text" v-model="settings.facebook" name="facebook" id="facebook"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                :placeholder="settings.facebook" aria-describedby="facebook-optional" />
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between">
                        ...
                        <div class="mt-2">
                            <input type="text" v-model="settings.instagram" name="instagram" id="instagram"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                :placeholder="settings.instagram" aria-describedby="instagram-optional" />
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between">
                        ...
                        <div class="mt-2">
                            <input type="text" v-model="settings.discord" name="discord" id="discord"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                :placeholder="settings.discord" aria-describedby="discord-optional" />
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between">
                        ...
                        <div class="mt-2">
                            <input type="text" v-model="settings.twitter" name="twitter" id="twitter"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                :placeholder="settings.twitter" aria-describedby="twitter-optional" />
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between">
                        ...
                        <div class="mt-2">
                            <input type="text" v-model="settings.twitch" name="twitch" id="twitch"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                :placeholder="settings.twitch" aria-describedby="twitch-optional" />
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between">
                        ...
                        <div class="mt-2">
                            <input type="text" v-model="settings.youtube" name="youtube" id="youtube"
                                class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                :placeholder="settings.youtube" aria-describedby="youtube-optional" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex justify-end gap-4 py-3 items-center">
                ...
                <button :disabled="settings.processing" @click="resetSettings" type="button"
                    ...
                    :class="settings.processing ? 'bg-gray-300 hover:bg-gray-300' : ''">
                    <ArrowPathIcon class="-ml-0.5 h-5 w-5" aria-hidden="true" />
                    Reset
                </button>
                <button :disabled="settings.processing" @click="updateSettings" type="button"
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <tr v-for="theme in themes" :key="theme.name">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{
                                            String.prototype.substring.call(theme.description, 0, 90) }}</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ theme.version }}</td>
                                        <td
                                            class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                                            <button v-if="!theme?.active" @click="activateTheme(theme.name)"
                                                class="text-indigo-600 hover:text-indigo-900">Activate</button>
                                            <span v-else
                                                class="bg-green-700/70 text-white text-xs px-4 py-1.5 rounded-full cursor-default">In
                                                Use</span>
                                        </td>
                                    </tr>
                                </tbody>
