...
<template>
    <DashboardLayout title="Add Post">
        <form @submit.prevent="submit" >
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                <div>
                    ...
                    <div class="mt-2">
                        <input v-model="newPost.title" type="text" name="title" id="title" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"  />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input v-model="newPost.published_at" type="datetime-local" name="published_at" id="published_at" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                    </div>
                </div>
            </div>

            <QuillEditor theme="snow" ref="quill" toolbar="essential" v-model:content="newPost.content" contentType="html" style="height: 300px"/>
